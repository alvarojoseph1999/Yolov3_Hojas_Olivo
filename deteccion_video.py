                ...
                for x1, y1, x2, y2, conf, cls_conf, cls_pred in detection:
                    ...
                    if len(colors) > 0:
                        if cls_pred < len(colors):
                            ...
                            # cls_pred está fuera de los límites, tomar una acción alternativa
                            print("cls_pred está fuera de los límites válidos")
                    else:
                        # La lista colors está vacía, tomar una acción alternativa
                        print("La lista colors está vacía")
